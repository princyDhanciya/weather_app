...
function App() {
  ...
  const searchLocation = (event) => {
    if (event.key === 'Enter') {
      const apiKey = '410c3916a63225eee1add00d3579107d';
      ...
      <div className="container">
        ...
        {data.name !== undefined && (
          <div className="bottom">
            <div className="feels">
              <img src="./assets/drizzle.png" alt="Feels Like" className="icon" />
            ...
            <div className="wind">
              <img src="./assets/wind.png" alt="Wind Speed " className="icon" />
